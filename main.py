"""
main.py — Interface gráfica do jogo Snake com IA usando Pygame.
"""
...
def desenhar_moedas(tela, moedas, contador_quadros):
    """Desenha as moedas com efeito de brilho pulsante."""
    pulso = abs((contador_quadros % 40) - 20) / 20.0  # 0.0 a 1.0
    for moeda in moedas:
...
def desenhar_hud(tela, pontuacao, total, estado):
    """Desenha o painel superior com informações do jogo."""
    # Fundo do HUD
...
def desenhar_sobreposicao(tela, texto, cor):
    """Desenha tela de sobreposição (Game Over / Vitória)."""
    ...
    while executando:
        ...
        if jogo.estado == EstadoJogo.JOGANDO:
            ...
            if direcao:
                ...
                # Guarda o caminho para visualização
